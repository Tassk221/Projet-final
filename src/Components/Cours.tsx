                        ...
                        {visibleClasses.map((sportClass) => (
                            <article key={sportClass.title} className="group flex h-full flex-col rounded-lg bg-[#222222]">
                                ...
                                <div className="flex flex-1 flex-col space-y-4 p-6">
                                    ...
                                    <button
                                        type="button"
                                        className="mt-2 inline-flex w-full items-center justify-center rounded-md bg-orange-300 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-[#181818] opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                                    >
                                        Reserver
                                    </button>
                                </div>
